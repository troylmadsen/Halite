...
# Possible enemies that the bot may face to learn to fight different strategies
enemy_models = ["MyBot-2.py", "AggressiveBot.py", "EconomyBot.py"]
...
for num in range(iterations):
    try:
        ...
        if Bot1_rank == 1:
            ...
            #     with open("c8_input.vec","r") as f:
            #         input_lines = f.readlines()
            #     with open("train.in","a") as f:
            #         for l in input_lines:
            #             f.write(l)
            #
            #     with open("c8_out.vec","r") as f:
            #         output_lines = f.readlines()
            #     with open("train.out","a") as f:
            #         for l in output_lines:
            #             f.write(l)
